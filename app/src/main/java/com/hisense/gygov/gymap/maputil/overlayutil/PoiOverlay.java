...
public class PoiOverlay extends OverlayManager {
    ...
    public final List<OverlayOptions> getOverlayOptions() {
        ...
        for (int i = 0; i < mPoiResult.getAllPoi().size() && markerSize < MAX_POI_SIZE; i++) {
            ...
            markerList.add(new MarkerOptions().icon(BitmapDescriptorFactory.fromResource(R.mipmap.icon_gcoding))
                    .extraInfo(bundle).position(mPoiResult.getAllPoi().get(i).location));
